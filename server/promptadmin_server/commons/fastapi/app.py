...
def create_lifespan(background_tasks: list[BackgroundTask] = None):
    @asynccontextmanager
...
def create_app(background_tasks: list[BackgroundTask] = None, docs_url: str = None, redoc_url: str = None,
               openapi_url: str = None) -> FastAPI:
